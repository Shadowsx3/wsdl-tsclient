...
(function () {
    return __awaiter(this, void 0, void 0, function () {
        var outDir, errorsCount, filePatterns, matches, _i, matches_1, match, wsdlPath, wsdlName, err_1, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, glob_1.glob)(filePatterns)];
                case 3:
                    matches = _a.sent();
                    if (matches.length === 0) {
                        logger_1.Logger.error("No WSDL files found");
                ...
                case 7:
                    err_1 = _a.sent();
                    logger_1.Logger.error("Error occurred while generating client \"".concat(wsdlName, "\""));
                ...
                case 9:
                    if (errorsCount) {
                        logger_1.Logger.error("".concat(errorsCount, " Errors occurred!"));
                        process.exit(1);
                    }
                    return [3 /*break*/, 11];
                case 10:
                    err_2 = _a.sent();
                    logger_1.Logger.error("Error while searching for WSDL files: ".concat(err_2));
                    process.exit(1);
                    return [3 /*break*/, 11];
